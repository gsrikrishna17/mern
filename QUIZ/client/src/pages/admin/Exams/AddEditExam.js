...
import { addExam, editExamById, getExamById,deleteQuestionById } from '../../../apicalls/exam';
import PageTitle from '../../../components/PageTitle';
import { Col, Row, Form, message, Tabs, Table } from 'antd'
  ...
  },
  {
    ...
    render:(text,record)=>(
      <div className="flex gap-2">
            ...
            <i className="ri-delete-bin-4-fill" onClick={()=>{
  ...
  return (
    <div>
      ...
      <div className="divider"></div>
         {(examData || !params.id) && (  <Form layout="vertical" onFinish={onFinish}
      initialValues={examData}>
        <Tabs defaultActiveKey="1">
          ...
          onClick={()=>navigate("/admin/exams")}>Cancel</button>
